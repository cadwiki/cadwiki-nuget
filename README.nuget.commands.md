...
Get-Project -All | UnInstall-Package cadwiki.CadDevTools
Get-Project -All | Install-Package E:\GitHub\cadwiki\cadwiki-nuget\cadwiki-nuget\cadwiki.CadDevTools.2.0.0.1.nupkg
Get-Project -All | Install-Package E:\GitHub\cadwiki\cadwiki-nuget\cadwiki-nuget\cadwiki.NUnitTestRunner.2.0.0.1.nupkg
Get-Project -All | Install-Package E:\GitHub\cadwiki\cadwiki-nuget\cadwiki-nuget\cadwiki.DllReloader.2.0.0.1.nupkg
```
...
### Push nuget package 
```  
nuget push ./cadwiki.NUnitTestRunner.2.0.0.1.nupkg apikey -src https://www.nuget.org/  
nuget push ./cadwiki.DllReloader.2.0.0.1.nupkg apikey -src https://www.nuget.org/  
nuget push ./cadwiki.CadDevTools.2.0.0.1.nupkg apikey -src https://www.nuget.org/  
```
