...
namespace cadwiki.AC25.Interop
{
    public class InteropUtils
    {
        ...
        private string autocadProgId = "AutoCAD.Application.25";
        ...
        private AcadApplication GetRunningAutoCADInstance()
        {
            ...
            try
            {
                appAcad = (AcadApplication)GetActiveObjectByProgId(autocadProgId);
            }
            catch (COMException ex)
            {
                Debug.WriteLine("AutoCAD instance not found: " + ex.Message);
            }
