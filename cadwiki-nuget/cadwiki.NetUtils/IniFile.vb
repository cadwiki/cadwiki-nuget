...
Public Class IniFile
    ...
    Private Declare Ansi Function GetPrivateProfileInt Lib "kernel32.dll" Alias "GetPrivateProfileIntA" (
        ...
        ByVal lpFileName As String) As Integer
    Private Declare Ansi Function FlushPrivateProfileString Lib "kernel32.dll" Alias "WritePrivateProfileStringA" (
    ...
    Public Function GetString(ByVal Section As String, ByVal Key As String, ByVal [Default] As String) As String
        ...
        If intCharCount > 0 Then
            Dim stringValue As String = Left(objResult.ToString, intCharCount)
            Return stringValue
        End If
        Return Nothing
    End Function
