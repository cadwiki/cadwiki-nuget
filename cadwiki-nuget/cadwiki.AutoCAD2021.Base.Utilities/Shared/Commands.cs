...
namespace cadwiki.AutoCAD2021.Base.Utilities
{
    ...
    public class Commands
    {
        ...
        public static void SendLispCommandStartUndoMark()
        {
            ...
            global::Autodesk.AutoCAD.ApplicationServices.Core.Application.DocumentManager.MdiActiveDocument.SendStringToExecute(str + Constants.vbLf, true, false, false);
        }
