...
namespace cadwiki.AutoCAD2022.Interop.Utilities
{
    ...
    public class InteropUtils
    {
        ...
        private readonly string AutoCADProgId = "AutoCAD.Application.R24.1";
        ...
        public bool NetloadDll(string dllPath)
        {
            ...
            doc.SendCommand("(setvar \"secureload\" 0)" + Constants.vbLf);
            dllPath = dllPath.Replace(@"\", @"\\");
            doc.SendCommand("(command \"_netload\" \"" + dllPath + "\")" + Constants.vbLf);
            return true;
        }
        ...
        public bool LoadCuiFile(string cuiMenuFileName, string menuGroupName)
        {
            ...
            var mainCui = (string)App.ActiveDocument.GetVariable("MENUNAME");
            string cuiFile = mainCui + ".cui";
        ...
        {
            string trustedPathsString = Convert.ToString(appAcad.ActiveDocument.GetVariable("TRUSTEDPATHS"));
