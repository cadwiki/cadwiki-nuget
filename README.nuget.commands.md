...
Get-Project -All | Install-Package E:\GitHub\cadwiki\cadwiki-nuget\cadwiki-nuget\cadwiki.CadDevTools.1.0.13.1525.nupkg
Get-Project -All | Install-Package E:\GitHub\cadwiki\cadwiki-nuget\cadwiki-nuget\cadwiki.NUnitTestRunner.1.0.13.1525.nupkg
Get-Project -All | Install-Package E:\GitHub\cadwiki\cadwiki-nuget\cadwiki-nuget\cadwiki.DllReloader.1.0.13.1525.nupkg
```
...
### Push nuget package 
```  
nuget push ./cadwiki.NUnitTestRunner.1.0.13.1525.nupkg apikey -src https://www.nuget.org/  
nuget push ./cadwiki.DllReloader.1.0.13.1525.nupkg apikey -src https://www.nuget.org/  
nuget push ./cadwiki.CadDevTools.1.0.13.1525.nupkg apikey -src https://www.nuget.org/  
```
